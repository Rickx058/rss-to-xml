...
def update_xml_feed(rss_url, output_file):
    ...
    # Add and commit the XML file to the repository
    os.system(f'git add {output_file}')
    os.system(f'git -c user.name="GitHub Actions" -c user.email="actions@users.noreply.github.com" commit -m "Add XML file generated by GitHub Actions"')
    os.system('git push')
